...
**Cardia** is a simple, easy-to-use maternal heart health awareness app that helps pregnant and postpartum users understand heart-related risks, recognize warning signs, and connect pregnancy experiences to lifelong cardiovascular health.
...
Helping users connect symptoms, pregnancy history, health conditions, and heart disease risk over time.
...
- Easy onboarding
- Heart health-focused education
...
Cardia is built around the idea that maternal heart health should be easy to understand and easy to act on.

By making heart health education simple, personalized, and supportive, Cardia helps users recognize that pregnancy and postpartum experiences can shape lifelong cardiovascular health, not just health during one stage of life.
