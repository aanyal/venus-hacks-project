...
enum MockData {
    ...
    static let allReels: [ReelItem] = [
        .init(id: 1, categories: ["chd", "advocacy", "heart"], grad: ["E05C97", "ED8DBB"], emoji: "❤️", tag: "Heart Health", title: "Living with CHD as an adult — what to ask at checkups", creator: "@dr.amara_heart", likes: "12.4K", badge: "Advocacy Pick ✨", matchReason: "Matches your heart-health focus", verified: true),
        .init(id: 2, categories: ["blood pressure", "postpartum"], grad: ["F0A500", "ED8DBB"], emoji: "🩺", tag: "Blood Pressure", title: "Blood pressure after pregnancy: why follow-up matters", creator: "@herhealthmatters", likes: "9.1K", badge: nil, matchReason: "Postpartum wellness", verified: true),
        .init(id: 3, categories: ["diabetes", "heart"], grad: ["2ABFBD", "ED8DBB"], emoji: "🍎", tag: "Diabetes", title: "How blood sugar and heart health are connected", creator: "@nutritionfirst.md", likes: "8.9K", badge: nil, matchReason: "Diabetes & heart education", verified: false),
        .init(id: 4, categories: ["pregnancy", "symptoms"], grad: ["B060C8", "E05C97"], emoji: "🌸", tag: "Pregnancy", title: "Heart symptoms women should feel comfortable asking about", creator: "@heartmamas", likes: "21K", badge: "Community Story", matchReason: "General awareness", verified: false),
        .init(id: 5, categories: ["advocacy", "heart"], grad: ["8B3A5E", "E05C97"], emoji: "📣", tag: "Advocacy", title: "How to advocate at your next cardiology appointment", creator: "@herhealthmatters", likes: "34K", badge: "Must Watch 🌸", matchReason: "Self-advocacy", verified: true),
        .init(id: 6, categories: ["nutrition", "general"], grad: ["F0A500", "ED8DBB"], emoji: "🥗", tag: "Nutrition", title: "Anti-inflammatory meals for heart wellness 🌸", creator: "@nutritionfirst.md", likes: "5.2K", badge: nil, matchReason: "Wellness basics", verified: false),
    ]

    static let communitySeeds: [CommunityMatchSeed] = [
        .init(id: UUID(), name: "Dr. Amara Osei", detail: "Cardiologist · CHD Specialist", avatar: "👩🏾‍⚕️", conditions: ["Congenital heart disease (CHD)"], lifeStage: "General", age: 42, interests: ["advocacy"], breastfeeding: false, verified: true, isGroup: false),
        .init(id: UUID(), name: "HeartMamas Group", detail: "Community · 2.4K members", avatar: "💗", conditions: ["High blood pressure"], lifeStage: "Postpartum", age: 30, interests: ["community"], breastfeeding: true, verified: true, isGroup: true),
        .init(id: UUID(), name: "NutritionFirst", detail: "Wellness coach · Anti-inflammatory", avatar: "🥗", conditions: ["Diabetes"], lifeStage: "Pregnant", age: 29, interests: ["nutrition"], breastfeeding: false, verified: false, isGroup: true),
        .init(id: UUID(), name: "CardioCoach", detail: "Exercise · cardiac-safe workouts", avatar: "🏃", conditions: ["High blood pressure"], lifeStage: "General", age: 35, interests: ["movement"], breastfeeding: false, verified: false, isGroup: true),
        .init(id: UUID(), name: "Her Health Matters", detail: "Advocacy network · CHD focus", avatar: "📣", conditions: ["Congenital heart disease (CHD)"], lifeStage: "Postpartum", age: 31, interests: ["advocacy"], breastfeeding: false, verified: true, isGroup: true),
    ]
    ...
    private static func pregnancyMilestones(profile: UserProfile) -> [RoadmapMilestone] {
        ...
        return [
            ...
            .init(week: "Week 16", label: "Symptom review", sub: "Review any new symptoms with your care team.", icon: "❤️", done: w > 16, active: w > 16 && w <= 20, tab: .pregnancy),
    ...
    private static func postpartumMilestones(profile: UserProfile) -> [RoadmapMilestone] {
        [
            ...
            .init(week: "1 year PP", label: "Annual heart care", sub: "Keep heart health part of annual care.", icon: "✨", tab: .postpartum),
        ]
    }
