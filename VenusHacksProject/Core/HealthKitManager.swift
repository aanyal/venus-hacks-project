...
enum HealthKitManagerError: LocalizedError {
    ...
    case missingShareUsageDescription
    ...
    var errorDescription: String? {
        ...
        case .missingShareUsageDescription:
            return "Apple Health sharing is not configured for this app."
        }
    }
}
...
final class HealthKitManager {
    ...
    func requestReadAuthorization() async throws {
        ...
        guard Self.hasHealthShareUsageDescription else {
            throw HealthKitManagerError.missingShareUsageDescription
        }
    ...
    #if canImport(HealthKit)
    private static var hasHealthShareUsageDescription: Bool {
